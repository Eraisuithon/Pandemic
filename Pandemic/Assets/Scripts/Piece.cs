...
public class Piece : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            {"Blue_Chicago", new HashSet<string>() {"Blue_Atlanta", "Blue_Montreal", "Blue_SanFrancisco", "Yellow_MexicoCity", "Yellow_LosAngeles"} },
            ...
            {"Blue_SanFrancisco", new HashSet<string>() {"Blue_Chicago", "Red_Tokyo", "Red_Manila", "Yellow_LosAngeles"} },
            ...
            {"Yellow_Khartoum", new HashSet<string>() {"Yellow_Kinshasa", "Yellow_Johannesburg", "Yellow_Lagos", "Black_Cairo"} },
            ...
            {"Red_Manila", new HashSet<string>() {"Red_HoChiMinhCity", "Red_Taipei", "Red_HongKong", "Red_Sydney", "Blue_SanFrancisco"} },
            ...
            {"Red_Tokyo", new HashSet<string>() {"Red_Seoul", "Red_Shanghai", "Red_Osaka", "Blue_SanFrancisco"} },
